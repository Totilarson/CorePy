...
- This folder has several python scripts that are used for various functions.
 ...
 - **Corebox_crop.py** - takes corebox images and crops them into core tubes with depth registration
 - **Corepy_plotting.py** - makes various cross plots and depth profiles (chemofacies and element concentrations) to evaluate clustering results
